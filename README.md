...
Want to help contribute? Visit our [Contributing](https://yomi-docs.readthedocs.io/en/latest/community/contributing/index.html) page to learn how to.

## Roadmap

Below is the roadmap of things we will soon be working on.

### Version 1.0

- [ ] 100% `classes/` coverage
- [ ] Completed placeholder tutorials
- [ ] 1.9.21 Update

### Future

- [ ] YOMI Gameplay Documentation
- [ ] Community Plugin/Mod Documentation
